...
from src.models.modulated_llama_llama8b import ModulatedLlamaForCausalLM
...
def parse_args():
    ...
    ap.add_argument('--config', default='configs/default_llama8b.yaml')
...
def main():
    ...
    raw_output_dir = tr_cfg.get('output_dir', 'modulated_tuned_model_llama8b')
