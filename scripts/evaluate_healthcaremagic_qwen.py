...
def parse_args():
    ...
    parser.add_argument("--base_model_name", type=str, default="models/Qwen2.5-7B-Instruct")
    parser.add_argument("--data_file", type=str, default="src/data/HealthCareMagic/chatdoctor_test.json", help="Path to local data or HF path")
    parser.add_argument("--batch_size", type=int, default=6)
    parser.add_argument("--output_file", type=str, default="eval_original_task_qwen/healthcaremagic/baseline_qwen.json")
