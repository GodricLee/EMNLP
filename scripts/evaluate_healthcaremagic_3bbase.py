...
def parse_args():
    ...
    parser.add_argument("--base_model_name", type=str, default="models/Llama-3.2-3B-Base")
    ...
    parser.add_argument("--output_file", type=str, default="eval_original_task/healthcaremagic/baseline_3bbase.json")
